...
<body class="bg-dark">
	...
	<div class="container mt-3">
		<center>
		<h1 class="text-success">Insert products</h1>
		</center>
		<!-- form -->
		<form action="" method="post" enctype="multipart/form-data">
			...
			<div class="form-outline mb-4 w-50 m-auto">
				<label for="product_title" class="form-label text-light">
					Product Title
				</label>
			...
			<!-- Keyword -->	
			<div class="form-outline mb-4 w-50 m-auto">			
				<label for="product_keywords" class="form-label text-light">
					Product Keywords
				</label>
			...
			<!-- Categories -->
				...
				<!-- Image1 -->	
				<div class="form-outline mb-4 w-50 m-auto">
					<label for="product_image1" class="form-label text-light">
						Product image 1
					</label>
				...
				<!-- Image2 -->	
				<div class="form-outline mb-4 w-50 m-auto">
					<label for="product_image2" class="form-label text-light">
						Product image 2
					</label>
				...
				<!-- Image3 -->	
				<div class="form-outline mb-4 w-50 m-auto">
					<label for="product_image3" class="form-label text-light">
						Product image 3
					</label>
				...
				<!-- Price -->	
				<div class="form-outline mb-4 w-50 m-auto">			
					<label for="product_price" class="form-label text-light">
						Product Price
					</label>
...
<!-- my small foot-->
<div class="bg-success p-3 text-light footer">
<center>
