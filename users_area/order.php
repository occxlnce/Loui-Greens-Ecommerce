...
// orders pending
$insert_pending_orders = "INSERT INTO user_orders (user_id, invoice_number, product_id, quantity, order_status) VALUES ('$user_id', '$invoie_number', '$product_id', '$quantity', '$status')";

$result_pending_orders=mysqli_query($con,$insert_pending_orders);

// delete items from cart_details
