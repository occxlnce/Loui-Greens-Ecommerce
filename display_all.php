...
<head>
	...
	<title> Shop all | Fruits, Vegetables, Herbs, beverages </title>
...
<section class="hero bg-dark">
  <div class="hero-content">
    <h1>We are Loui Greens</h1>
    <p class="subtitle">We Produce A Diverse Selection Of Crisp Vegetables, Juicy Fruits, Flagrant Herbs</p>
  </div>
</section>
...
<div class="bg-light">
	<center>
	<h3 class="text-success">Shop all</h3>
	</center>
	<p class="text-center">From vegetables, fruits, veggies, and herbs.</p>
</div>
